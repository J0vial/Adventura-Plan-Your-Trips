...
<body data-spy="scroll" data-target=".fixed-top">
    ...
    <nav class="navbar navbar-expand-md navbar-dark navbar-custom fixed-top">
        ...
        <!-- Image Logo -->
        <a class="navbar-brand logo-image" href="index.html"><h1 style="color:aliceblue">Adventura</h1></a>
        ...
        <div class="collapse navbar-collapse" id="navbarsExampleDefault">
            <ul class="navbar-nav ml-auto">
                ...
                <li class="nav-item">
                    <a class="nav-link page-scroll" href="#callMe">TRIP PLAN</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link page-scroll" href="#projects">HOTELS</a>
                </li>
                <li class="nav-item">
