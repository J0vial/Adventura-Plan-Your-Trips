    ...
    <div class="header-content">
        ...
        @if( $plan_data == 0)
            ...
            <form action="{{route('confirm')}}" method="POST">
                ...
                <div class="select">
                    <select class="form-select" name='place' aria-label="Default select example" id='place' value="{{ old('place')}}">
        ...
        @else
        <div id="yourPlans" style="display: block;">
            <h1>Your Plans</h1>
            <table class="table table-striped">
                ...
                <button style='margin-top:2%;font-size: 15px;'class="btn-solid-lg page-scroll">Make a New Plan </button>
            </div>
        @endif
